  ...
  try {
    const response = await openai.createChatCompletion({
      ...
      messages : [
        {
          'role' : 'system',
          'content' : 'mbti전문가의 입장으로 각 질문 Q에 대한 질문인 대답 A 를 보고 전체 A의 내용이 얼마나 이성적이고 논리적, 분석적이며 객관적으로 사실을 판단하는지를, 혹은 얼마나 차갑고 냉정하게 말하고 못되게 말하는지를 몇 퍼센트인지 분석하고 대답해줘. 예를 들어서 T성향이 100%라고 한다면 각 A의 모든 내용들이 욕설이 포함되고 질문인 Q와는 전혀 관련없는 대답뿐이고 차갑고 냉정하고 냉혈한처럼 대답했다는 뜻이야. 어떠한 설명도 하지말고 \'T: %\'이 정규식에 맞게만 숫자로 대답 해줘. '
        },
        {
          role : 'user',
